...
function App() {
  ...
  return (
    <div
      ...
      ">
      <h1 className=" text-3xl text-center bg-slate-500 p-4 rounded-b-lg text-white">DroneMapping Error Predictor Model</h1>
      <div className='flex flex-col items-center shadow-md p-10 mt-5 bg-white bg-opacity-70 w-1/3 rounded-xl '>
        <div className=' flex flex-col '>
          ...
          <div className=' m-4'>
            <select className=' rounded-md border-2 p-2 m-4' id="options" value={distribution} onChange={handleSelectChange}>
        ...
        <div>
          {selection && <div>{(selection === "percent") ? <p className='text-center'>Drone Mode:<br /> Percent Overlap: {percentValue}</p> : <p>Drone Mode: RTK</p>}</div>}
        </div>
        <div>
